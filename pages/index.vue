<template>
    ...
    <section >
      <!-- hero container -->
       <div class=" w-full bg=cover bg-center"></div>
      <img src='https://nadia.s3.amazonaws.com/hero_4.jpg' class='w-full h-full object-cover'/>
        ...
        <div class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full">
                ...
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <img class="object-cover w-full h-full" src="https://nadia.s3.amazonaws.com/Sunset-Station-Property-Hero-Shot.jpg" alt="" />
                        </a>

                        <div class="absolute top-4 left-4">
                            <span class="px-4 py-2 text-xs font-semibold tracking-widest text-gray-900 uppercase bg-white rounded-full"> Casinos </span>
                        </div>
                    </div>
            ...
            <div class="overflow-hidden bg-white rounded shadow">
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <img class="object-cover w-full h-full" src="public/Table Reports.jpg" alt="" />
                        </a>

                        <div class="absolute top-4 left-4">
                            <span class="px-4 py-2 text-xs font-semibold tracking-widest text-gray-900 uppercase bg-white rounded-full"> Table Reports </span>
                        </div>
                    </div>
                    ...
                    <!-- <NuxtLink to="/TableReports"> Viewww Table Reports</NuxtLink> -->
                </div>
            </div>
            ...
            <div class="overflow-hidden bg-white rounded shadow">
                <div class="p-5">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="px-4 py-2 text-xs font-semibold tracking-widest text-gray-900 uppercase bg-white rounded-full"> News and Deals </span>
                        </div>
                    </div>
                    <!-- <span class="block mt-6 text-sm font-semibold tracking-widest text-gray-500 uppercase"> May 12, 2020 </span> -->
                    <p class="mt-5 text-2xl font-semibold">
                        <a href="#" title="" class="text-black"> Casino Special Offers and News </a>
                    </p>
